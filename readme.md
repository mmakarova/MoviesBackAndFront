...
1. После загрузки страницы показываются редкатор ввода фильма, редактор выбора жанра, кнопка Поиск и фильмы для певой страницы (количество фильмов 4 на странице). 
